...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Lab3_t, stringdata) + ofs \
...
const QMetaObject Lab3::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_Lab3.data,
      qt_meta_data_Lab3,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Lab3::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Lab3.stringdata))
        return static_cast<void*>(const_cast< Lab3*>(this));
